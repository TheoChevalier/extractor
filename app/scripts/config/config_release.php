...
$target_repo = GIT . 'en-US-release';
$moz_repo = new HgRepo(HG . 'RELEASE_EN-US/mozilla-release');
$moz_repo->short_name  = 'mozilla-release';
$moz_repo->web_link    = 'releases/mozilla-release';
$moz_repo->origin      = 'Mozilla Release';
$moz_repo->repo_dirs   = $moz_repo_dirs;
$moz_repo->save_latest = CACHE_PATH . 'latest_' . $moz_repo->short_name . '.txt';

$comm_repo = new HgRepo(HG . 'RELEASE_EN-US/comm-release');
$comm_repo->short_name  = 'comm-release';
$comm_repo->web_link    = 'releases/comm-release';
$comm_repo->origin      = 'Comm Release';
